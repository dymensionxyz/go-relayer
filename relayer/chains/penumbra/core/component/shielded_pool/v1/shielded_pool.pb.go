...
type EventOutboundFungibleTokenRefund_Reason int32

const (
	// No particular reason.
	EventOutboundFungibleTokenRefund_REASON_UNSPECIFIED EventOutboundFungibleTokenRefund_Reason = 0
	// The transfer timed out.
	EventOutboundFungibleTokenRefund_REASON_TIMEOUT EventOutboundFungibleTokenRefund_Reason = 1
	// The transfer was acknowledged with an error.
	EventOutboundFungibleTokenRefund_REASON_ERROR EventOutboundFungibleTokenRefund_Reason = 2
)

var EventOutboundFungibleTokenRefund_Reason_name = map[int32]string{
	0: "REASON_UNSPECIFIED",
	1: "REASON_TIMEOUT",
	2: "REASON_ERROR",
}

var EventOutboundFungibleTokenRefund_Reason_value = map[string]int32{
	"REASON_UNSPECIFIED": 0,
	"REASON_TIMEOUT":     1,
	"REASON_ERROR":       2,
}

func (x EventOutboundFungibleTokenRefund_Reason) String() string {
	return proto.EnumName(EventOutboundFungibleTokenRefund_Reason_name, int32(x))
}

func (EventOutboundFungibleTokenRefund_Reason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_26a9f446de1cd73c, []int{29, 0}
}
...
type FungibleTokenTransferPacketMetadata struct {
...
func (m *FungibleTokenTransferPacketMetadata) Reset()         { *m = FungibleTokenTransferPacketMetadata{} }
func (m *FungibleTokenTransferPacketMetadata) String() string { return proto.CompactTextString(m) }
func (*FungibleTokenTransferPacketMetadata) ProtoMessage()    {}
func (*FungibleTokenTransferPacketMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_26a9f446de1cd73c, []int{27}
}
func (m *FungibleTokenTransferPacketMetadata) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FungibleTokenTransferPacketMetadata) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FungibleTokenTransferPacketMetadata.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FungibleTokenTransferPacketMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FungibleTokenTransferPacketMetadata.Merge(m, src)
}
func (m *FungibleTokenTransferPacketMetadata) XXX_Size() int {
	return m.Size()
}
func (m *FungibleTokenTransferPacketMetadata) XXX_DiscardUnknown() {
	xxx_messageInfo_FungibleTokenTransferPacketMetadata.DiscardUnknown(m)
}

var xxx_messageInfo_FungibleTokenTransferPacketMetadata proto.InternalMessageInfo

func (m *FungibleTokenTransferPacketMetadata) GetChannel() string {
	if m != nil {
		return m.Channel
	}
	return ""
...
func (m *FungibleTokenTransferPacketMetadata) GetSequence() uint64 {
	if m != nil {
		return m.Sequence
	}
	return 0
...
type EventOutboundFungibleTokenTransfer struct {
	// The value being transferred out of the chain.
	Value *v12.Value `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
	// The sending address on chain.
	Sender *v11.Address `protobuf:"bytes,2,opt,name=sender,proto3" json:"sender,omitempty"`
	// The receiving address, which we don't assume anything about.
	Receiver string                               `protobuf:"bytes,3,opt,name=receiver,proto3" json:"receiver,omitempty"`
	Meta     *FungibleTokenTransferPacketMetadata `protobuf:"bytes,4,opt,name=meta,proto3" json:"meta,omitempty"`
}

func (m *EventOutboundFungibleTokenTransfer) Reset()         { *m = EventOutboundFungibleTokenTransfer{} }
func (m *EventOutboundFungibleTokenTransfer) String() string { return proto.CompactTextString(m) }
func (*EventOutboundFungibleTokenTransfer) ProtoMessage()    {}
func (*EventOutboundFungibleTokenTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_26a9f446de1cd73c, []int{28}
}
func (m *EventOutboundFungibleTokenTransfer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventOutboundFungibleTokenTransfer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventOutboundFungibleTokenTransfer.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventOutboundFungibleTokenTransfer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventOutboundFungibleTokenTransfer.Merge(m, src)
}
func (m *EventOutboundFungibleTokenTransfer) XXX_Size() int {
	return m.Size()
}
func (m *EventOutboundFungibleTokenTransfer) XXX_DiscardUnknown() {
	xxx_messageInfo_EventOutboundFungibleTokenTransfer.DiscardUnknown(m)
}

var xxx_messageInfo_EventOutboundFungibleTokenTransfer proto.InternalMessageInfo

func (m *EventOutboundFungibleTokenTransfer) GetValue() *v12.Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *EventOutboundFungibleTokenTransfer) GetSender() *v11.Address {
	if m != nil {
		return m.Sender
	}
	return nil
...
func (m *EventOutboundFungibleTokenTransfer) GetReceiver() string {
	if m != nil {
		return m.Receiver
	}
	return ""
...
func (m *EventOutboundFungibleTokenTransfer) GetMeta() *FungibleTokenTransferPacketMetadata {
	if m != nil {
		return m.Meta
	}
	return nil
...
type EventOutboundFungibleTokenRefund struct {
	...
	Reason EventOutboundFungibleTokenRefund_Reason `protobuf:"varint,4,opt,name=reason,proto3,enum=penumbra.core.component.shielded_pool.v1.EventOutboundFungibleTokenRefund_Reason" json:"reason,omitempty"`
	// This will be the metadata for the packet for the transfer being refunded.
	//
	// This allows linking a refund to the transfer.
	Meta *FungibleTokenTransferPacketMetadata `protobuf:"bytes,5,opt,name=meta,proto3" json:"meta,omitempty"`
}

func (m *EventOutboundFungibleTokenRefund) Reset()         { *m = EventOutboundFungibleTokenRefund{} }
func (m *EventOutboundFungibleTokenRefund) String() string { return proto.CompactTextString(m) }
func (*EventOutboundFungibleTokenRefund) ProtoMessage()    {}
func (*EventOutboundFungibleTokenRefund) Descriptor() ([]byte, []int) {
	return fileDescriptor_26a9f446de1cd73c, []int{29}
}
func (m *EventOutboundFungibleTokenRefund) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventOutboundFungibleTokenRefund) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventOutboundFungibleTokenRefund.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventOutboundFungibleTokenRefund) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventOutboundFungibleTokenRefund.Merge(m, src)
}
func (m *EventOutboundFungibleTokenRefund) XXX_Size() int {
	return m.Size()
}
func (m *EventOutboundFungibleTokenRefund) XXX_DiscardUnknown() {
	xxx_messageInfo_EventOutboundFungibleTokenRefund.DiscardUnknown(m)
}

var xxx_messageInfo_EventOutboundFungibleTokenRefund proto.InternalMessageInfo

func (m *EventOutboundFungibleTokenRefund) GetValue() *v12.Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *EventOutboundFungibleTokenRefund) GetSender() *v11.Address {
	if m != nil {
		return m.Sender
	}
	return nil
...
func (m *EventOutboundFungibleTokenRefund) GetReceiver() string {
	if m != nil {
		return m.Receiver
	}
	return ""
...
func (m *EventOutboundFungibleTokenRefund) GetReason() EventOutboundFungibleTokenRefund_Reason {
	if m != nil {
		return m.Reason
	}
	return EventOutboundFungibleTokenRefund_REASON_UNSPECIFIED
}

func (m *EventOutboundFungibleTokenRefund) GetMeta() *FungibleTokenTransferPacketMetadata {
	if m != nil {
		return m.Meta
	}
	return nil
...
type EventInboundFungibleTokenTransfer struct {
	// The value being transferred in.
	Value *v12.Value `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
	// The sender on the counterparty chain.
	Sender string `protobuf:"bytes,2,opt,name=sender,proto3" json:"sender,omitempty"`
	// The receiver on this chain.
	Receiver *v11.Address                         `protobuf:"bytes,3,opt,name=receiver,proto3" json:"receiver,omitempty"`
	Meta     *FungibleTokenTransferPacketMetadata `protobuf:"bytes,4,opt,name=meta,proto3" json:"meta,omitempty"`
}

func (m *EventInboundFungibleTokenTransfer) Reset()         { *m = EventInboundFungibleTokenTransfer{} }
func (m *EventInboundFungibleTokenTransfer) String() string { return proto.CompactTextString(m) }
func (*EventInboundFungibleTokenTransfer) ProtoMessage()    {}
func (*EventInboundFungibleTokenTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_26a9f446de1cd73c, []int{30}
}
func (m *EventInboundFungibleTokenTransfer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventInboundFungibleTokenTransfer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventInboundFungibleTokenTransfer.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventInboundFungibleTokenTransfer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventInboundFungibleTokenTransfer.Merge(m, src)
}
func (m *EventInboundFungibleTokenTransfer) XXX_Size() int {
	return m.Size()
}
func (m *EventInboundFungibleTokenTransfer) XXX_DiscardUnknown() {
	xxx_messageInfo_EventInboundFungibleTokenTransfer.DiscardUnknown(m)
}

var xxx_messageInfo_EventInboundFungibleTokenTransfer proto.InternalMessageInfo

func (m *EventInboundFungibleTokenTransfer) GetValue() *v12.Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *EventInboundFungibleTokenTransfer) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *EventInboundFungibleTokenTransfer) GetReceiver() *v11.Address {
	if m != nil {
		return m.Receiver
	}
	return nil
...
func (m *EventInboundFungibleTokenTransfer) GetMeta() *FungibleTokenTransferPacketMetadata {
	if m != nil {
		return m.Meta
	}
	return nil
...
func init() {
	proto.RegisterEnum("penumbra.core.component.shielded_pool.v1.EventOutboundFungibleTokenRefund_Reason", EventOutboundFungibleTokenRefund_Reason_name, EventOutboundFungibleTokenRefund_Reason_value)
	...
	proto.RegisterType((*FungibleTokenTransferPacketMetadata)(nil), "penumbra.core.component.shielded_pool.v1.FungibleTokenTransferPacketMetadata")
	proto.RegisterType((*EventOutboundFungibleTokenTransfer)(nil), "penumbra.core.component.shielded_pool.v1.EventOutboundFungibleTokenTransfer")
	proto.RegisterType((*EventOutboundFungibleTokenRefund)(nil), "penumbra.core.component.shielded_pool.v1.EventOutboundFungibleTokenRefund")
	proto.RegisterType((*EventInboundFungibleTokenTransfer)(nil), "penumbra.core.component.shielded_pool.v1.EventInboundFungibleTokenTransfer")
}
...
var fileDescriptor_26a9f446de1cd73c = []byte{
	...
	,
}
...
func (m *FungibleTokenTransferPacketMetadata) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FungibleTokenTransferPacketMetadata) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FungibleTokenTransferPacketMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Sequence != 0 {
		i = encodeVarintShieldedPool(dAtA, i, uint64(m.Sequence))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Channel) > 0 {
		...
		i = encodeVarintShieldedPool(dAtA, i, uint64(len(m.Channel)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *EventOutboundFungibleTokenTransfer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventOutboundFungibleTokenTransfer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventOutboundFungibleTokenTransfer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Receiver) > 0 {
		...
		i = encodeVarintShieldedPool(dAtA, i, uint64(len(m.Receiver)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Sender != nil {
...
func (m *EventOutboundFungibleTokenRefund) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventOutboundFungibleTokenRefund) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventOutboundFungibleTokenRefund) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Reason != 0 {
		i = encodeVarintShieldedPool(dAtA, i, uint64(m.Reason))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Receiver) > 0 {
...
func (m *EventInboundFungibleTokenTransfer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventInboundFungibleTokenTransfer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventInboundFungibleTokenTransfer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Sender) > 0 {
		...
		i = encodeVarintShieldedPool(dAtA, i, uint64(len(m.Sender)))
		i--
		dAtA[i] = 0x12
	}
	if m.Value != nil {
...
func (m *FungibleTokenTransferPacketMetadata) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Sequence != 0 {
		n += 1 + sovShieldedPool(uint64(m.Sequence))
	}
	return n
}

func (m *EventOutboundFungibleTokenTransfer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventOutboundFungibleTokenRefund) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Reason != 0 {
		n += 1 + sovShieldedPool(uint64(m.Reason))
	}
	if m.Meta != nil {
		l = m.Meta.Size()
		n += 1 + l + sovShieldedPool(uint64(l))
...
func (m *EventInboundFungibleTokenTransfer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FungibleTokenTransferPacketMetadata) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FungibleTokenTransferPacketMetadata: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FungibleTokenTransferPacketMetadata: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EventOutboundFungibleTokenTransfer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventOutboundFungibleTokenTransfer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventOutboundFungibleTokenTransfer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			if m.Meta == nil {
				m.Meta = &FungibleTokenTransferPacketMetadata{}
			}
...
func (m *EventOutboundFungibleTokenRefund) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventOutboundFungibleTokenRefund: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventOutboundFungibleTokenRefund: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Reason |= EventOutboundFungibleTokenRefund_Reason(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *EventInboundFungibleTokenTransfer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventInboundFungibleTokenTransfer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventInboundFungibleTokenTransfer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
